...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'Welcome to B4U Wallet and Exchange.',
    ...
    'page.body.landing.register.item.text': 'B4U Wallet and Exchange offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'B4U Wallet and Exchange platform features',
    'page.body.landing.features.features.item1.title': 'Exchange',
    'page.body.landing.features.features.item2.title': 'Order Types',
    'page.body.landing.features.features.item3.title': 'Low Fees',
    ...
    'page.body.landing.features.features.item1.text': 'B4U Wallet and Exchange offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'B4U Wallet and Exchange offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    'page.body.landing.features.features.item3.text': 'Our Exchange provide very low fees in deposit and withdrawal and during trading As you trade high fees will go down',

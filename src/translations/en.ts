...
export const en = {
    ...
    'page.body.deposit.network.tag.instruction': 'Please enter both Tag and Address data, which are required to deposit {currency} to your B4U account successfully.',

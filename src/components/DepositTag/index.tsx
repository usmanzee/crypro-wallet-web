...
export interface DepositTagProps {
    /**
 ...
 */
const DepositTag: React.FunctionComponent<DepositTagProps> = (props: DepositTagProps) => {
    // const QR_SIZE = 118;
    ...
    const { data, error, text, copiableTextFieldText, copyButtonText, handleOnCopy, disabled } = props;

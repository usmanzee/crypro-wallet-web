...
import { DEFAULT_TABLE_PAGE_LIMIT } from '../constants';
import { offersFetch, selectP2PPaymentMethodsData } from '../modules';

export const useP2POffersFetch = ({ limit = DEFAULT_TABLE_PAGE_LIMIT, page = 0, side = 'buy', payment_method = '', base = '', quote = '', sort = '' }) => {

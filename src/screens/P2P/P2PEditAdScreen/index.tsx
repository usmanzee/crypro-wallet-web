...
import { 
    ...
    createOffer,
    selectP2PUserOfferDetail,
    selectP2PUserOfferDetailLoading,
...
const P2PEditAdComponent = (props: Props) => {
    ...
    const [selectedFiatCurrency, setSelectedFiatCurrency] = React.useState<Currency>(null);
    ...
    const offerDetail = useSelector(selectP2PUserOfferDetail);
    const offerDetailLoading = useSelector(selectP2PUserOfferDetailLoading);
    ...
    const getExchangeRates = async () => {
        ...
        const response = await fetchRate(selectedCryptoCurrency.id.toLowerCase(), selectedFiatCurrency.id.toLowerCase(), 1);
        if (response.data) {
    ...
    const handleNext = () => {
        if(activeStep == 0) {
            ...
            var requestObject = {
                ...
                quote_unit: selectedFiatCurrency.id.toLowerCase(),
            ...
            <> 
                <div className={classes.selectDropdown} onClick={handleFiatCurrencySelectClick}>
                        <>
                            ...
                            <Typography variant="subtitle1" component="div" className={classes.currencyName}>
                                {selectedFiatCurrency ? selectedFiatCurrency.id.toUpperCase() : ''}
                            </Typography>
                ...
                >
                    ...
                    <Autocomplete
                        ...
                        getOptionLabel={(option: Currency) => option ? option.id : ''}
                        renderInput={(params) => (
                            <InputBase
            ...
            <>
               ...
               <div style={{ display: 'flex' }}>
                    <div style={{ marginRight: '24px' }}>
                        ...
                        <Typography variant="h5">{`${finalPrice} ${selectedFiatCurrency ? selectedFiatCurrency.id : ''}`}</Typography>
                    </div>
                    {/* <div>
               ...
               {selectedPriceType != 'fixed' ? <div style={{ display: 'flex'}}>
                    ...
                    <Typography>{selectedFiatCurrency.id.toUpperCase()}</Typography>
                </div> : ''}
            </>
        );
    }
                ...
                <div className={classes.secondStepContentDiv}>
                    <FormControl variant="outlined" fullWidth error={totalAmountErrorMessage != ''}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            <FormLabel>{`Available: ${selectedWallet ? selectedWallet.balance : ''} ${selectedCryptoCurrency ? selectedCryptoCurrency.id.toUpperCase() : ''} `}</FormLabel>
                        </div>
                        <TextField
                            ...
                            InputProps={{
                                endAdornment: <InputAdornment position="end">
                                    ...
                                    <Typography>{selectedCryptoCurrency ? selectedCryptoCurrency.id.toUpperCase() : ''}</Typography>
                                </InputAdornment>,
                            }}
                        />
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <FormControl variant="outlined" fullWidth error={minOrderAmountErrorMessage != ''}>
                            <TextField
                                ...
                                InputProps={{
                                    endAdornment: <InputAdornment position="end">
                                        <Typography>{selectedFiatCurrency ? selectedFiatCurrency.id.toUpperCase() : ''}</Typography>
                                    </InputAdornment>,
                                }}
                            />
...
export const P2PEditAdScreen = P2PEditAdComponent;
...
const P2PEditAdComponent = (props: Props) => {
    ...
    const p2pUserOfferDetailLoading = useSelector(selectP2PUserOfferDetailLoading);
    const p2pUserOfferDetail = useSelector(selectP2PUserOfferDetail);
    ...
    React.useEffect(() => {
        ...
        dispatch(userOfferDetailFetch({id: 1}));
    }, []);
